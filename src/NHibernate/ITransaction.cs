...
namespace NHibernate
{
	...
	public partial interface ITransaction : IDisposable
	{
		...
		/// </summary>
		/// <param name="synchronization">The <see cref="ITransactionCompletionSynchronization"/> callback to register.</param>
		void RegisterSynchronization(ITransactionCompletionSynchronization synchronization);
	}
}
