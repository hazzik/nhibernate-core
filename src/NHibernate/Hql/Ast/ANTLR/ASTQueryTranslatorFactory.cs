...
namespace NHibernate.Hql.Ast.ANTLR
{
	...
	public class ASTQueryTranslatorFactory : IQueryTranslatorFactory2
	{
		...
		{
			return CreateQueryTranslators(queryString, new StringQueryExpression(queryString), collectionRole, shallow, filters, factory);
		}
		...
		{
			return CreateQueryTranslators(queryExpression.Translate(factory, collectionRole != null), queryIdentifier, collectionRole, shallow,
										  filters, factory);
		}
