...
namespace NHibernate.Cache
{
	...
	public partial interface ICacheConcurrencyStrategy
	{
		...
		/// <summary>
		/// Gets or sets the <see cref="CacheBase"/> for this strategy to use.
		/// </summary>
		/// <value>The <see cref="CacheBase"/> for this strategy to use.</value>
		CacheBase Cache { get; set; }
		...
		/// <exception cref="CacheException"></exception>
		bool[] PutMany(CacheKey[] keys, object[] values, long timestamp, object[] versions, IComparer[] versionComparers, bool[] minimalPuts);
	}
}
