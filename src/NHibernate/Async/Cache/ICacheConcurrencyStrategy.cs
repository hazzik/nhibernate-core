...
namespace NHibernate.Cache
{
	...
	public partial interface ICacheConcurrencyStrategy
	{
		...
		/// <exception cref="CacheException"></exception>
		Task<bool[]> PutManyAsync(CacheKey[] keys, object[] values, long timestamp, object[] versions, IComparer[] versionComparers, bool[] minimalPuts, CancellationToken cancellationToken);
	}
}
